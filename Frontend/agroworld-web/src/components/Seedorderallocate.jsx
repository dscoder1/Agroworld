...
const Seedorderallocate = () => {
    ...
    const{id}=useParams()
       ...
       const [logindata,setlogindata]=useState("")
           ...
           const response=await axios.get(`http://localhost:3000/allocateseedorder/${id}`)
           console.log(response.data)
           console.log(response.data[0].Seedname)
           setvegetablename(response.data[0].Seedname)
       ...
       const handleSeedAllocateForm=async(e)=>{
                   ...
                   const response=await axios.post("http://localhost:3000/allocateseedorder",{vegetablekg,vegetablename,vegetableprice,vegetablesellernumber,locationorder,vegetableallocaternumber,vegetablebuyernumber,iddata,logindata})
                   console.log(response.data)
...
export default Seedorderallocate
