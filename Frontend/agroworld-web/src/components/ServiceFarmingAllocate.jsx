...
const ServiceFarmingAllocate = () => {
       const[allseedallocatedadmin,setallseedallocatedadmin]=useState([])
        const fun=async()=>{
        const response10=await axios.get("http://localhost:3000/allallocatedotherorderservice")
 ...
 <a href="/servicefarmingview" ><button id='orderbutton'>Order Done</button></a>
     </div>
     </div>
     </>
    ))}
...
export default ServiceFarmingAllocate
