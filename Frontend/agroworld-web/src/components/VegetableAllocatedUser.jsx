...
const VegetableAllocatedUser = () => {
    const[allseedallocatedadmin,setallseedallocatedadmin]=useState([])
    const fun=async()=>{
    const response10=await axios.get("http://localhost:3000/allallocatedvegetableorderuser")
     ...
     {allseedallocatedadmin.map(values => (
        <>
         <div className="eachbox">
          ...
          <p>Veletable Name : {values.Vegetablename}</p>
...
export default VegetableAllocatedUser
